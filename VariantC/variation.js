(function () {
  try {
    ...
    var encouragementLine = '' +
      '<div class = "bm-encouragementLine"> <span> <img src="https://bm-test-dev.s3.us-east-2.amazonaws.com/GrowthRock/%5BCart%5D+Encouragement+line/cart.png"> </span> <span> Almost there! You\'re minutes away from authentic Polk sound. </span></div>';
    /* Variation Init */
    function init() {
      _$('body').addClass('gr-testEncouragementLine')
      _$('.minicart .minicart-buttons a[href*="shoppingcart"]').text('Edit Cart')
      _$('.minicart .minicart-buttons a[href*="checkout"]').text('Checkout Now')
      // _$('.minicart .minicart-buttons a[href*="shoppingcart"]').insertBefore(encouragementLine)

      const send = XMLHttpRequest.prototype.send
      XMLHttpRequest.prototype.send = function () {
        this.addEventListener('load', function () {
          if (this.responseURL.indexOf('/GetCartCount') > -1) {
            if (document.querySelector('.bm-encouragementLine')) return
    ...
    helper.waitForElement(".minicart .minicart-buttons a[href*='/en-us/checkout']", init);
  } catch (e) {
