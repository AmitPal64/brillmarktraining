...
'  '+ 
'              <div class="image">'+ 
'                  <img src="https://i.postimg.cc/0jXwQ9Bz/Vector-5.png" alt="">'+ 
'              </div>'+ 
'          </div>'+ 
'      </div>'+ 
'  </div>';
...
var htmlString2 =''+ 
'  <div class="image1">'+ 
'      <img src="https://i.postimg.cc/x1Q6hgyZ/Vector-6.png" alt="">'+ 
'  </div>';

      var helper = _$();
      /* Variation Init */
      function init() {
        _$('.c-product-tabs > :first-child .c-product-tabs__content').insertAfter(htmlString1)
        _$('.c-product-tabs > :first-child .c-product-tabs__title').append(htmlString2)
        // _$('.c-product-tabs  .c-product__size-chart .product-size-guide').prepend(htmlString2)
        
      }
  

      /* Initialise variation */
      helper.waitForElement(".c-product-tabs > :first-child .c-product-tabs__title", init, 50, 15000);
    } catch (e) {
