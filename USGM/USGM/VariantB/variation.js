(function () {
    try {
      ...
      var USGM =''+ 
'  <div>'+ 
'      <h1>Have Your Cake and Eat It Too: Get Postal Mail With the Convenience Of Online Management</h1>'+ 
'  </div>';
      ...
      /* Variation Init */
      function init() {
        _$('.main_page_wrap .home_Page_inner .container .home_top_part  .row  >.home-main-left').html(USGM)
      ...
      helper.waitForElement(".main_page_wrap .home_Page_inner .container .home_top_part  .row  >.home-main-left", init, 50, 15000);
    } catch (e) {
